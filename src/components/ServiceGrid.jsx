      ...
      <Row className="service-grid-row">
          <Col xs={12} sm={12} md={6} lg={4} className="service-grid-col">
              <Card className="service-grid-card">
                  <img src={busqueda_img} alt="Search Truck Cargo" className="service-grid-card-img"/>
              </Card>
          </Col>

          <Col xs={12} sm={12} md={6} lg={4} className="service-grid-col">
              <Card className="service-grid-card">
                  <img src={precio_img} alt="Negotiating Truck Cargo" className="service-grid-card-img"/>
              </Card>
          </Col>

          <Col xs={12} sm={12} md={6} lg={4} className="service-grid-col">
              <Card className="service-grid-card">
                  <img src={setup_img} alt="Setup Truck Cargo" className="service-grid-card-img"/>
              </Card>
          </Col>

          <Col xs={12} sm={12} md={6} lg={4} className="service-grid-col">
              <Card className="service-grid-card">
                  <img src={detention_img} alt="Detention Truck Cargo" className="service-grid-card-img"/>
              </Card>
          </Col>

          <Col xs={12} sm={12} md={6} lg={4} className="service-grid-col">
              <Card className="service-grid-card">
                  <img src={complemento_img} alt="Completing Truck Cargo" className="service-grid-card-img"/>
              </Card>
          </Col>

          <Col xs={12} sm={12} md={6} lg={4} className="service-grid-col">
              <Card className="service-grid-card">
                  <img src={analitica_img} alt="Analytics Truck Cargo" className="service-grid-card-img"/>
              </Card>
          </Col>
      </Row>
      </div>
